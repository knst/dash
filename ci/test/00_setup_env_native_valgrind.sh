...
export NO_DEPENDS=1
export TEST_RUNNER_EXTRA="--exclude rpc_bind,fature_bind_extra --timeout-factor=4"  # Excluded for now, see https://github.com/bitcoin/bitcoin/issues/17765#issuecomment-602068547
export GOAL="install"
