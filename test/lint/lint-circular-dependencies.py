...
EXPECTED_DASH_CIRCULAR_DEPENDENCIES = (
    ...
    "evo/creditpool -> validation -> evo/evochainstate -> evo/creditpool",
    "evo/evochainstate -> evo/specialtxman -> llmq/commitmentpool -> evo/evochainstate",
    "evo/evochainstate -> evo/mnhftx -> llmq/quorumsman -> evo/evochainstate",
    "evo/evochainstate -> evo/mnhftx -> validation -> evo/evochainstate",
