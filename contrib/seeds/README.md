...
The seeds compiled into the release are created from current protx list and AS map
...
python3 makeseeds.py -a asmap-filled.dat protx_list.json onion_seeds.txt > nodes_main.txt
