...
void ObjRequestTracker::SanityCheck() const { m_impl->SanityCheck(); }

void ObjRequestTracker::PostGetRequestableSanityCheck(std::chrono::microseconds now) const
{
...
uint64_t ObjRequestTracker::ComputePriority(const uint256& txhash, NodeId peer, bool preferred) const
{
