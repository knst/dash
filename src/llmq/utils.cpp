...
// Forward declarations
static std::vector<CDeterministicMNCPtr> ComputeQuorumMembers(Consensus::LLMQType llmqType, const CDeterministicMNList& mn_list,
...
static std::vector<CDeterministicMNCPtr> GetMNUsageBySnapshot(
    ...
    const CBlockIndex* pCycleQuorumBaseBlockIndex, const llmq::CQuorumSnapshot& snapshot, int nHeight)
{
    ...
    std::vector<CDeterministicMNCPtr> sortedCombinedMns;
    {
        ...
        sortedCombinedMns = GetMNUsageBySnapshot(llmqParams, mn_list, pCycleQuorumBaseBlockIndex,
                                                                snapshot);
    }
