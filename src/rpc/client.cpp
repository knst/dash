...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "getrawtransactionmulti", 1, "verbosity" },
    ...
    { "protx shared_register_prepare", 2, "shares" },
    { "protx shared_register_prepare", 3, "coreP2PAddrs", true },
    { "protx shared_register_prepare", 7, "earlyPeriodBlocks" },
    { "protx shared_register_prepare", 8, "earlyPenalty" },
    { "protx revoke", 3, "reason" },
    { "protx revoke", 5, "submit" },
    { "protx shared_combine", 2, "signatures" },
    { "protx shared_combine", 3, "submit" },
    { "protx shared_dissolve", 2, "actorIndex" },
    { "protx shared_dissolve", 3, "fee" },
    { "protx shared_dissolve", 4, "submit" },
    { "protx shared_dissolve", 5, "payPenalty" },
    { "protx shared_dissolve_prepare", 2, "actorIndex" },
    { "protx shared_dissolve_prepare", 3, "fee" },
    { "protx shared_sign", 2, "allowTimeLocks" },
    { "protx shared_update_share", 2, "shareIndex" },
    { "protx shared_update_share", 5, "submit" },
