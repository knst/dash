...
CSimplifiedMNList::CSimplifiedMNList(const CDeterministicMNList& dmnList)
{
    ...
    LogPrintf("sizeof uint256: %d\n", sizeof(uint256));
    LogPrintf("sizeof uint160: %d\n", sizeof(uint160));
    LogPrintf("sizeof CService: %d\n", sizeof(CService));
    LogPrintf("sizeof CBLSLazyPublicKey: %d\n", sizeof(CBLSLazyPublicKey));
    LogPrintf("sizeof CKeyID: %d\n", sizeof(CKeyID));
    LogPrintf("sizeof CScript: %d\n", sizeof(CScript));
    LogPrintf("sizeof MnType: %d\n", sizeof(MnType));
    LogPrintf("sizeof mutex: %d\n", sizeof(std::mutex));
    LogPrintf("sizeof BLSObject(CBLSPublicKey): %d\n", sizeof(CBLSPublicKey));
    LogPrintf("sizeof g1: %d\n", sizeof(bls::G1Element));
    LogPrintf("sizeof g2: %d\n", sizeof(bls::G2Element));
    LogPrintf("sizeof bls-private: %d\n", sizeof(bls::PrivateKey));
//    LogPrintf("sizeof : %d\n", sizeof());
    struct A  {
    ...
    struct AA { 
        ...
        mutable std::array<uint8_t, 32> vecBytes;

        mutable CBLSPublicKey obj;
    ...
    LogPrintf("size of A, B, C %d %d %d\n", sizeof(A), sizeof(B), sizeof(C));
    LogPrintf("size of AA, AB %d %d\n", sizeof(AA), sizeof(AB));
    // 24
    LogPrintf("sizeof CSimplifiedMNList: %d\n", sizeof(CSimplifiedMNList));
