    ...
    const CScript& scriptPubKey)
{
    ...
    std::unique_ptr<CBlockTemplate> pblocktemplate = BlockAssembler(::ChainstateActive(), *m_node.evodb, *m_node.llmq_ctx, *m_node.mn_subsidy, *m_node.mempool, chainparams).CreateNewBlock(scriptPubKey);
