    ...
    : BasicTestingSetup(chainName, extra_args)
{
    ...
    m_node.govman = std::make_unique<CGovernanceManager>(*m_node.netfulfilledman, *m_node.sporkman);
    ...
    : ChainTestingSetup(chainName, extra_args)
{
    ...
    m_node.chainman->InitializeChainstate(m_node.mempool.get(), *m_node.mnhf_manager, *m_node.evodb, *m_node.govman, llmq::chainLocksHandler, llmq::quorumInstantSendManager, llmq::quorumBlockProcessor);
