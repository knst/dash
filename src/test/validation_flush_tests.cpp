...
BOOST_AUTO_TEST_CASE(getcoinscachesizestate)
{
    ...
    CChainState chainstate(&mempool, blockman, *m_node.mnhf_manager, *m_node.evodb, *m_node.mn_subsidy, llmq::chainLocksHandler, llmq::quorumInstantSendManager, llmq::quorumBlockProcessor);
