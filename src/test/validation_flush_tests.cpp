...
BOOST_AUTO_TEST_CASE(getcoinscachesizestate)
{
    ...
    CChainState chainstate(&mempool, blockman, *m_node.mnhf_manager, *m_node.evodb, *m_node.govman, llmq::chainLocksHandler, llmq::quorumInstantSendManager, llmq::quorumBlockProcessor);
