...
BlockAssembler::BlockAssembler(CChainState& chainstate, CEvoDB& evoDb, LLMQContext& llmq_ctx, MNSubsidyAgent& mn_subsidy,
...
BlockAssembler::BlockAssembler(CChainState& chainstate, CEvoDB& evoDb, LLMQContext& llmq_ctx, MNSubsidyAgent& mn_subsidy,
    ...
    : BlockAssembler(chainstate, evoDb, llmq_ctx, mn_subsidy, mempool, params, DefaultOptions()) {}
...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    m_mn_subsidy.FillBlockPayments(coinbaseTx, pindexPrev, blockSubsidy, nFees, pblocktemplate->voutMasternodePayments, pblocktemplate->voutSuperblockPayments);
