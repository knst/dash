...
public:
    ...
    /** Sign a hash with the given script */
    virtual SigningResult SignHash(const uint256& hash, const PKHash& pkhash, std::string& str_sig) const { return SigningResult::SIGNING_FAILED; };
...
public:
    ...
    SigningResult SignHash(const uint256& hash, const PKHash& pkhash, std::string& str_sig) const override;
