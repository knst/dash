...
(e.g. P2WPKH [not appliable for Dash]), and the wallet would still detect outputs sending to the new address type
...
The change to using descriptors changes the default derivation paths used by Dash Core
